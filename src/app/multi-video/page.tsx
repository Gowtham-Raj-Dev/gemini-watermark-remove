    ...
    <div className="gwr-landing">
      ...
      <section className="hero" style={{ paddingBottom: '30px', paddingTop: '60px' }}>
        <div className="wrap">
          ...
          <h1>Multiple Videos<br /><span className="free-shine">Watermark Remover</span></h1>
          <p className="sub">
            Erase Gemini watermarks, logos, and overlays from multiple MP4, WebM, and MOV videos at once.
            Processing happens rapidly and sequentially on your device.
          </p>
          <div className="tabs" style={{ marginTop: '24px' }}>
            <a href="/video" className="tab">Single Video</a>
            <a href="/multi-video" className="tab active">Multi Videos</a>
          </div>
      ...
      <div className="tool" id="tool" style={{ maxWidth: '940px', margin: '44px auto 0', padding: '0 24px' }}>
        ...
        <div id="dropzone" className="dropzone" data-dragging="false" role="button" tabIndex={0} style={{ padding: "46px 24px", opacity: isEngineLoading ? 0.6 : 1, pointerEvents: isEngineLoading ? 'none' : 'auto', marginBottom: '28px', border: '2px dashed var(--border)', borderRadius: 'var(--radius)', background: 'linear-gradient(180deg, var(--card), var(--bg-soft))', textAlign: 'center', cursor: 'pointer', transition: '0.2s' }}>
          ...
          <h3 style={{ fontSize: '19px', margin: '0 0 6px 0', fontWeight: 600 }}>Drag & drop multiple videos here</h3>
          ...
          <input id="fileInput" type="file" accept="video/mp4,video/webm,video/quicktime,video/*" multiple hidden disabled={isEngineLoading} />
        </div>
        ...
        <div className="panel controls-panel" style={{ background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 'var(--radius)', padding: '24px', boxShadow: '0 4px 24px rgba(0,0,0,0.04)' }}>
          ...
          {/* MULTI VIDEO QUEUE */}
          <div id="fileQueuePanel" style={{ display: 'none', marginTop: '24px' }}>
            <div style={{ fontSize: '13px', fontWeight: 600, color: 'var(--muted)', marginBottom: '10px' }}>Multi Processing Queue</div>
            <div id="fileQueueList" className="queue-list custom-scrollbar" style={{ display: 'flex', flexDirection: 'column', gap: '8px', maxHeight: '220px', overflowY: 'auto', paddingRight: '4px' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', marginTop: '24px' }}>
            ...
            <button id="resetBtn" type="button" className="btn btn-ghost" style={{ flex: '1', padding: '12px 16px', whiteSpace: 'nowrap' }}>Clear Queue</button>
            <button id="processBtn" className="btn btn-primary" type="button" style={{ flex: '1.5', padding: '12px 16px', fontSize: '15px', whiteSpace: 'nowrap' }}>Auto Clean Batch</button>
      ...
      <section className="seo-content" style={{ marginTop: '60px', padding: '60px 0', background: 'var(--bg-soft)' }}>
        <div className="wrap">
          <div className="sec-head" style={{ textAlign: 'center', marginBottom: '48px', maxWidth: '720px', margin: '0 auto 48px' }}>
            ...
            <h2 style={{ fontSize: 'clamp(28px, 4vw, 42px)', fontWeight: 800, marginTop: '12px', letterSpacing: '-1px' }}>The Best Multiple Video Watermark Remover</h2>
            <p style={{ color: 'var(--muted)', marginTop: '14px', fontSize: '17px' }}>
              Remove watermarks from your AI-generated videos in batches without compromising quality or privacy. Our tool runs directly in your browser, ensuring your files are never uploaded to any server.
            </p>
          </div>
      ...
      <section className="how-section" style={{ padding: '80px 0', background: 'var(--bg)' }}>
        <div className="wrap">
          <div className="sec-head" style={{ textAlign: 'center', marginBottom: '48px', maxWidth: '720px', margin: '0 auto 48px' }}>
            ...
            <h2 style={{ fontSize: 'clamp(28px, 4vw, 38px)', fontWeight: 800, letterSpacing: '-1px', marginTop: '12px' }}>How to Remove Multiple Video Watermarks Online</h2>
          </div>
          <div className="steps-container" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 280px), 1fr))', gap: '24px' }}>
            <div className="step-box" style={{ padding: '28px', border: '1px solid var(--border)', background: 'var(--card)', borderRadius: '16px', boxShadow: '0 1px 3px rgba(16,24,40,.04)' }}>
              ...
              <h3 style={{ fontSize: '18px', fontWeight: 700, marginBottom: '8px' }}>Upload Video(s)</h3>
              <p style={{ color: 'var(--muted)', fontSize: '14px' }}>Drag and drop your MP4, WebM, or MOV files into the workspace above. You can batch process multiple files.</p>
            </div>
            <div className="step-box" style={{ padding: '28px', border: '1px solid var(--border)', background: 'var(--card)', borderRadius: '16px', boxShadow: '0 1px 3px rgba(16,24,40,.04)' }}>
