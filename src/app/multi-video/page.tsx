    ...
    <div className="gwr-landing">
      ...
      <section className="hero" style={{ paddingBottom: '30px', paddingTop: '60px' }}>
        <div className="wrap">
          ...
          <h1><span className="free-shine">Multi</span> <span className="gradient-text">Multiple Videos</span><br />Watermark Remover</h1>
          <p className="sub">
      ...
      <div className="shell video-preview-shell" style={{ paddingTop: 0 }}>
        ...
        <div id="dropzone" className="dropzone" data-dragging="false" role="button" tabIndex={0} style={{ padding: "46px 24px", opacity: isEngineLoading ? 0.6 : 1, pointerEvents: isEngineLoading ? 'none' : 'auto', marginBottom: '28px' }}>
          ...
          <h3 style={{ fontSize: '19px', margin: '0 0 6px 0' }}>Drag & drop multiple videos here</h3>
            ...
            <div className="panel">
              ...
              <div className="controls">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', margin: '24px auto 12px' }}>
                  ...
                  <button id="resetBtn" type="button" className="btn btn-ghost" style={{ width: '100%', padding: '12px' }}>Clear Queue</button>
                  <button id="processBtn" className="btn btn-primary" type="button" style={{ width: '100%', padding: '12px' }}>Auto Clean Batch</button>
